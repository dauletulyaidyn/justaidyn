...
let SiteController = class SiteController {
    ...
    async sitemap(req, res) {
        ...
        const projectBase = (project) => isLocal ? `https://${project}.justaidyn.com` : `https://${project}.justaidyn.com`;
    ...
    toProjectSite(req, res, project, path = '/') {
        const host = req.hostname?.toLowerCase().split(':')[0] || '';
        const isLocalIp = host === 'localhost' || host === '127.0.0.1';
        const isLocalDomain = host.endsWith('.justaidyn.local');
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], SiteController.prototype, "robots", null);
__decorate([
